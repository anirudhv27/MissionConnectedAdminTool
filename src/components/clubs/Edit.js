...
class Edit extends Component {
  ...
  getUserData = () => {
    firebase.database().ref("/schools/missionsanjosehigh/clubs/" + this.props.match.params.id).on("value", snapshot => {
  ...
  onSubmit = (e) => {
    ...
    firebase.database().ref("/schools/missionsanjosehigh/clubs/" + this.props.match.params.id).update({
      club_name,
      club_preview,
      club_description,
          ...
          <div class="panel-body">
            <form onSubmit={this.onSubmit}>
              ...
              <div class="form-group">
                ...
                <textArea class="form-control" name="club_description" value={this.state.club_description} onChange={this.onChange} placeholder="Club Description" cols="80" rows="3">{this.state.club_description}</textArea>
              </div>
